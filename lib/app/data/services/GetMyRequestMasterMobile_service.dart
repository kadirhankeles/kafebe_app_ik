...
Future<GetMyRequestMasterMobileModel?> getMyRequestMasterMobileService(String statuCode) async {
  ...
  var url = Uri.parse('${ServiceConstants.BASE_URL}${ServiceConstants.GET_MY_REQUEST_MASTER_MOBILE}$query');
  var res = await http.post(url, headers: headers);
   await ServiceConstants()
        .responseControll(res.statusCode);
